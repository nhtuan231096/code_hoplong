<?php
    ...
    $mcImageManagerConfig['filesystem.rootpath'] = '../../../../../../../data/upload/blog/'; // absolute or relative from this script path, required.
	$mcImageManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
	$mcImageManagerConfig['filesystem.include_directory_pattern'] = '';
	$mcImageManagerConfig['filesystem.exclude_directory_pattern'] = '/^tiny_mce_cover$/i';
	...
	$mcImageManagerConfig['thumbnail.folder'] = "tiny_mce_cover"; // required, exclude this folder with file pattern '/^mcith$/i' if you don't want it to show
	$mcImageManagerConfig['thumbnail.prefix'] = "tiny_mce_cover_"; // 
